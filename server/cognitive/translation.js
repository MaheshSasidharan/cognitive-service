...
module.exports = {
  main: function(settings, audioStream) {
    ...
    translationConfig.addTargetLanguage(settings.translateToLanguage);
    ...
    recognizer.recognizing = function (s, e) {
        ...
        //settings.translateToLanguage  = "hi";
        str += " [" + settings.translateToLanguage + "] " + e.result.translations.get(settings.translateToLanguage);
