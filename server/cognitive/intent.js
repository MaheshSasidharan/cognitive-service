...
(function () {
    ...
    const intentService = function (settings, audioStream, wsClient) {

            const processedIntent = function (result) {
                wsClient.emit("processedIntent", result);
            };

            const endOfIntentRecognition = function (result) {
                wsClient.emit("endOfIntentRecognition", result);
            };
            ...
            intentConfig.speechRecognitionLanguage = settings.speechRecognitionLanguage;
            ...
            recognizer.recognizeOnceAsync(
                function (result) {
                    console.log("FINAL INTENT", result);
                    endOfIntentRecognition(result);
                    closeRecognizer();
                },
                function (err) {
                    closeRecognizer();
                    processedIntent("ERROR !!");
                    console.log(err);
                });
